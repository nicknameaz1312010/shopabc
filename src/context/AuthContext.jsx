...
const ADMIN_USER = { id: 0, name: 'Admin', email: 'admin@shopabc.com', username: 'admin1122', phone: '0900000000', role: 'admin' }
...
export function AuthProvider({ children }) {
  ...
  const login = useCallback((username, password) => {
    if (username === 'admin1122' && password === 'admin1122') {
      setUser(ADMIN_USER)
      localStorage.setItem('shopabc_user', JSON.stringify(ADMIN_USER))
      return true
    }
    const userData = { id: Date.now(), name: username, email: username + '@shopabc.com', username, phone: '', role: 'user' }
    setUser(userData)
